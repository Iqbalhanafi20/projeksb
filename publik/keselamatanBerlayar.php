    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="">Bidang Keselamatan Berlayar</a>
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu scroll" aria-labelledby="navbarDropdown">
          <a class="dropdown-item scroll" href="#kepelautan">Seksi Kepelautan</a>
          <a class="dropdown-item scroll" href="#tertib">Seksi Tertib Berlayar</a>
          <a class="dropdown-item scroll" href="#bandar">Seksi Tertib Bandar</a>
        </div>
      </li>
    </ul>
  </div>
...
<div class="container stat">
		...
		<div class="statusHukum">
				<center><h1>BIDANG KESELAMATAN BERLAYAR</h1></center>
			
				<!-- tabel Download Keselamatan Berlayar -->
				
				<section id="kepelautan">
				<h3>Seksi Kepelautan</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S004'");
				...
				<section id="tertib">
				<h3>Seksi Tertib Berlayar</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S005'");
							while($cet = mysql_fetch_array($qcet)){
						?>
						  <tbody>
						    <tr>
				...
				<section id="bandar">
				<h3>Seksi Tertib Bandar</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S006'");
							while($cet = mysql_fetch_array($qcet)){
						?>
						  <tbody>
						    <tr>
