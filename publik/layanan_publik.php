  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="tataUsaha.php">Bagian Tata Usaha</a>
          <a class="dropdown-item smooth" href="">Bidang Status Hukum dan Sertifikasi Kapal</a>
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item scroll" href="#keselamatanKapal">Seksi Sertifikasi Keselamatan Kapal</a>
          <a class="dropdown-item scroll" href="#pencemaran">Seksi Pencegahan Pencemaran dan Manajemen Keselamatan</a>
          <a class="dropdown-item scroll" href="#statushukum">Seksi Status Hukum Kapal</a>
        </div>
      </li>
    </ul>
  </div>
...
<div class="kotak">
	<div class="container stat">
		...
		<div class="statusHukum">
				<center><h1>BIDANG STATUS HUKUM & SERTIFIKASI KAPAL</h1></center>
			
				<!-- tabel Download File Status Hukum & Sertifikasi Kapal -->
				<section id="keselamatanKapal">
				<h3>Seksi Sertifikasi Keselamatan Kapal</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S001'");
				...
				<section id="pencemaran">
				<h3>Seksi Pencegahan Pencemaran dan Manajemen Keselamatan</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S002'");
							while($cet = mysql_fetch_array($qcet)){
						?>
						  <tbody>
						    <tr>
				...
				<section id="statushukum">
				<h3>Seksi Status Hukum Kapal</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S003'");
							while($cet = mysql_fetch_array($qcet)){
						?>
						  <tbody>
						    <tr>
