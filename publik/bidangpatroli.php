    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="">Bidang Penjagaan dan Patroli</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item scroll" href="#patroli">Seksi Patroli</a>
          <a class="dropdown-item scroll" href="#keselamatan">Seksi Penunjang Keselamatan dan Penyidikan</a>
          <a class="dropdown-item scroll" href="#penjagaan">Seksi Penjagaan</a>
        </div>
      </li>
    </ul>
  </div>
...
<div class="container stat">
		...
		<div class="statusHukum">
				<center><h1>BIDANG PENJAGAAN, PATROLI DAN PENYIDIKAN</h1></center>
			
				<!-- tabel Download bidang patroli -->
				<section id="patroli">
				<h3>Seksi Patroli</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S007'");
				...
				<section id="keselamatan">
				<h3>Seksi Penunjang Keselamatan dan Penyidikan</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S008'");
							while($cet = mysql_fetch_array($qcet)){
						?>
						  <tbody>
						    <tr>
				...
				<h3>Seksi Penjagaan</h3>
						<table class="table table-dark">
						<?php
							$qcet = mysql_query("SELECT * FROM t_seksidanfile WHERE id_seksi ='S009'");
							while($cet = mysql_fetch_array($qcet)){
						?>
						  <tbody>
						    <tr>
